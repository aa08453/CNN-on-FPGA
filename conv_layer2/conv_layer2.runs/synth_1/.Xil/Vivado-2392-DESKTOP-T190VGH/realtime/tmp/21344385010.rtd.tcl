...
set genomeRtd $env(RT_TMP)/21344385010.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {load_kernels__GB0}]"
...
set genomeName [subst -nocommands -novariables {load_kernels__GB0}]
