...
set genomeRtd $env(RT_TMP)/2134C931D90.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {layer2__GCB1}]"
...
set genomeName [subst -nocommands -novariables {layer2__GCB1}]
