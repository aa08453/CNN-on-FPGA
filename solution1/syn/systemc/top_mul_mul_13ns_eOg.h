...
// ==============================================================
#ifndef __top_mul_mul_13ns_eOg__HH__
#define __top_mul_mul_13ns_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_mul_13ns_eOg) {
    ...
    SC_CTOR(top_mul_mul_13ns_eOg):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
