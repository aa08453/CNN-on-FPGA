...
`define AESL_DEPTH_outputConv_V 1
`define AESL_DEPTH_weight_V 1
`define AESL_DEPTH_bias_V 1
`define AESL_DEPTH_outputPool_V 1
`define AESL_DEPTH_weight2_V 1
`define AESL_DEPTH_bias2_V 1
`define AESL_DEPTH_outputConv2_V 1
`define AESL_DEPTH_outputPool2_V 1
`define AESL_DEPTH_outputDense_V 1
`define AESL_DEPTH_fcWeight_V 1
`define AESL_DEPTH_fcBias_V 1
`define AUTOTB_TVIN_gmem  "./c.top.autotvin_gmem.dat"
`define AUTOTB_TVIN_input_V  "./c.top.autotvin_input_V.dat"
`define AUTOTB_TVIN_outputConv_V  "./c.top.autotvin_outputConv_V.dat"
`define AUTOTB_TVIN_weight_V  "./c.top.autotvin_weight_V.dat"
`define AUTOTB_TVIN_bias_V  "./c.top.autotvin_bias_V.dat"
`define AUTOTB_TVIN_outputPool_V  "./c.top.autotvin_outputPool_V.dat"
`define AUTOTB_TVIN_weight2_V  "./c.top.autotvin_weight2_V.dat"
`define AUTOTB_TVIN_bias2_V  "./c.top.autotvin_bias2_V.dat"
`define AUTOTB_TVIN_outputConv2_V  "./c.top.autotvin_outputConv2_V.dat"
`define AUTOTB_TVIN_outputPool2_V  "./c.top.autotvin_outputPool2_V.dat"
`define AUTOTB_TVIN_outputDense_V  "./c.top.autotvin_outputDense_V.dat"
`define AUTOTB_TVIN_fcWeight_V  "./c.top.autotvin_fcWeight_V.dat"
`define AUTOTB_TVIN_fcBias_V  "./c.top.autotvin_fcBias_V.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.top.autotvin_gmem.dat"
`define AUTOTB_TVIN_input_V_out_wrapc  "./rtl.top.autotvin_input_V.dat"
`define AUTOTB_TVIN_outputConv_V_out_wrapc  "./rtl.top.autotvin_outputConv_V.dat"
`define AUTOTB_TVIN_weight_V_out_wrapc  "./rtl.top.autotvin_weight_V.dat"
`define AUTOTB_TVIN_bias_V_out_wrapc  "./rtl.top.autotvin_bias_V.dat"
`define AUTOTB_TVIN_outputPool_V_out_wrapc  "./rtl.top.autotvin_outputPool_V.dat"
`define AUTOTB_TVIN_weight2_V_out_wrapc  "./rtl.top.autotvin_weight2_V.dat"
`define AUTOTB_TVIN_bias2_V_out_wrapc  "./rtl.top.autotvin_bias2_V.dat"
`define AUTOTB_TVIN_outputConv2_V_out_wrapc  "./rtl.top.autotvin_outputConv2_V.dat"
`define AUTOTB_TVIN_outputPool2_V_out_wrapc  "./rtl.top.autotvin_outputPool2_V.dat"
`define AUTOTB_TVIN_outputDense_V_out_wrapc  "./rtl.top.autotvin_outputDense_V.dat"
`define AUTOTB_TVIN_fcWeight_V_out_wrapc  "./rtl.top.autotvin_fcWeight_V.dat"
`define AUTOTB_TVIN_fcBias_V_out_wrapc  "./rtl.top.autotvin_fcBias_V.dat"
`define AUTOTB_TVOUT_gmem  "./c.top.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.top.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 50;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 606450;
parameter LENGTH_gmem = 21652;
parameter LENGTH_input_V = 1;
parameter LENGTH_outputConv_V = 1;
parameter LENGTH_weight_V = 1;
parameter LENGTH_bias_V = 1;
parameter LENGTH_outputPool_V = 1;
parameter LENGTH_weight2_V = 1;
parameter LENGTH_bias2_V = 1;
parameter LENGTH_outputConv2_V = 1;
parameter LENGTH_outputPool2_V = 1;
parameter LENGTH_outputDense_V = 1;
parameter LENGTH_fcWeight_V = 1;
parameter LENGTH_fcBias_V = 1;
...
wire [32 - 1:0] input_V;
wire [32 - 1:0] outputConv_V;
wire [32 - 1:0] weight_V;
wire [32 - 1:0] bias_V;
wire [32 - 1:0] outputPool_V;
wire [32 - 1:0] weight2_V;
wire [32 - 1:0] bias2_V;
wire [32 - 1:0] outputConv2_V;
wire [32 - 1:0] outputPool2_V;
wire [32 - 1:0] outputDense_V;
wire [32 - 1:0] fcWeight_V;
wire [32 - 1:0] fcBias_V;
AESL_axi_master_gmem AESL_AXI_MASTER_gmem(
    ...
    .TRAN_gmem_input_V (input_V),
    .TRAN_gmem_outputConv_V (outputConv_V),
    .TRAN_gmem_weight_V (weight_V),
    .TRAN_gmem_bias_V (bias_V),
    .TRAN_gmem_outputPool_V (outputPool_V),
    .TRAN_gmem_weight2_V (weight2_V),
    .TRAN_gmem_bias2_V (bias2_V),
    .TRAN_gmem_outputConv2_V (outputConv2_V),
    .TRAN_gmem_outputPool2_V (outputPool2_V),
    .TRAN_gmem_outputDense_V (outputDense_V),
    .TRAN_gmem_fcWeight_V (fcWeight_V),
    .TRAN_gmem_fcBias_V (fcBias_V),
...
AESL_axi_slave_control AESL_AXI_SLAVE_control(
    ...
    .TRAN_outputConv_V (outputConv_V),
    .TRAN_weight_V (weight_V),
    .TRAN_bias_V (bias_V),
    .TRAN_outputPool_V (outputPool_V),
    .TRAN_weight2_V (weight2_V),
    .TRAN_bias2_V (bias2_V),
    .TRAN_outputConv2_V (outputConv2_V),
    .TRAN_outputPool2_V (outputPool2_V),
    .TRAN_outputDense_V (outputDense_V),
    .TRAN_fcWeight_V (fcWeight_V),
    .TRAN_fcBias_V (fcBias_V),
...
reg end_outputConv_V;
reg [31:0] size_outputConv_V;
reg [31:0] size_outputConv_V_backup;
reg end_weight_V;
...
reg end_outputPool_V;
reg [31:0] size_outputPool_V;
reg [31:0] size_outputPool_V_backup;
reg end_weight2_V;
reg [31:0] size_weight2_V;
reg [31:0] size_weight2_V_backup;
reg end_bias2_V;
reg [31:0] size_bias2_V;
reg [31:0] size_bias2_V_backup;
reg end_outputConv2_V;
reg [31:0] size_outputConv2_V;
reg [31:0] size_outputConv2_V_backup;
reg end_outputPool2_V;
reg [31:0] size_outputPool2_V;
reg [31:0] size_outputPool2_V_backup;
reg end_outputDense_V;
reg [31:0] size_outputDense_V;
reg [31:0] size_outputDense_V_backup;
reg end_fcWeight_V;
reg [31:0] size_fcWeight_V;
reg [31:0] size_fcWeight_V_backup;
reg end_fcBias_V;
reg [31:0] size_fcBias_V;
reg [31:0] size_fcBias_V_backup;
