...
set C_modelArgList {
	...
	{ outputPool_V_offset int 32 regular  }
	{ Cin int 6 regular  }
	{ H int 6 regular  }
	{ W int 6 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_V", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "outputPool_V_offset", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "Cin", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ outputPool_V_offset sc_in sc_lv 32 signal 2 } 
	{ Cin sc_in sc_lv 6 signal 3 } 
	{ H sc_in sc_lv 6 signal 4 } 
	{ W sc_in sc_lv 6 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outputPool_V_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "outputPool_V_offset", "role": "default" }} , 
 	{ "name": "Cin", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "Cin", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "17769", "Max" : "141601"}
	, {"Name" : "Interval", "Min" : "17769", "Max" : "141601"}
]}
...
set Spec2ImplPortList { 
	...
	outputPool_V_offset { ap_none {  { outputPool_V_offset in_data 0 32 } } }
	Cin { ap_none {  { Cin in_data 0 6 } } }
