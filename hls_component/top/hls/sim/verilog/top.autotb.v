...
`define AESL_DEPTH_outputConv 1
`define AESL_DEPTH_weight 1
`define AESL_DEPTH_bias 1
`define AESL_DEPTH_outputPool 1
`define AESL_DEPTH_weight2 1
`define AESL_DEPTH_bias2 1
`define AESL_DEPTH_outputConv2 1
`define AESL_DEPTH_outputPool2 1
`define AESL_DEPTH_outputDense 1
...
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_input_r.dat"
`define AUTOTB_TVIN_outputConv_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_outputConv.dat"
`define AUTOTB_TVIN_weight_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_weight.dat"
`define AUTOTB_TVIN_bias_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_bias.dat"
`define AUTOTB_TVIN_outputPool_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_outputPool.dat"
`define AUTOTB_TVIN_weight2_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_weight2.dat"
`define AUTOTB_TVIN_bias2_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_bias2.dat"
`define AUTOTB_TVIN_outputConv2_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_outputConv2.dat"
`define AUTOTB_TVIN_outputPool2_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_outputPool2.dat"
`define AUTOTB_TVIN_outputDense_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_outputDense.dat"
`define AUTOTB_TVIN_fcWeight_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_fcWeight.dat"
`define AUTOTB_TVIN_fcBias_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_fcBias.dat"
`define AUTOTB_TVOUT_gmem0  "../tv/cdatafile/c.top.autotvout_gmem0.dat"
`define AUTOTB_TVOUT_gmem0_out_wrapc  "../tv/rtldatafile/rtl.top.autotvout_gmem0.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 50;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 140719;
parameter LENGTH_bias = 1;
parameter LENGTH_bias2 = 1;
parameter LENGTH_fcBias = 1;
parameter LENGTH_fcWeight = 1;
parameter LENGTH_gmem0 = 12928;
parameter LENGTH_gmem1 = 9448;
parameter LENGTH_input_r = 1;
parameter LENGTH_outputConv = 1;
parameter LENGTH_outputConv2 = 1;
parameter LENGTH_outputDense = 1;
parameter LENGTH_outputPool = 1;
parameter LENGTH_outputPool2 = 1;
parameter LENGTH_weight = 1;
parameter LENGTH_weight2 = 1;
