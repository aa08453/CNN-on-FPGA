...
TOOLCHAIN += --gcc-toolchain=/home/abdullah/Xilinx/2025.2/Vitis/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/eight.cpp_pre.cpp.tb.o : eight.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling eight.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
