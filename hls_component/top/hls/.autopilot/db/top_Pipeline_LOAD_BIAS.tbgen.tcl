set moduleName top_Pipeline_LOAD_BIAS
set isTopModule 0
...
set cdfgNum 22
set C_modelName {top_Pipeline_LOAD_BIAS}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem1 int 8 regular {axi_master 0 stable }  }
	{ fcBias int 64 regular  }
	{ local_bias_9_out int 8 regular {pointer 1}  }
	{ local_bias_8_out int 8 regular {pointer 1}  }
	{ local_bias_7_out int 8 regular {pointer 1}  }
	{ local_bias_6_out int 8 regular {pointer 1}  }
	{ local_bias_5_out int 8 regular {pointer 1}  }
	{ local_bias_4_out int 8 regular {pointer 1}  }
	{ local_bias_3_out int 8 regular {pointer 1}  }
	{ local_bias_2_out int 8 regular {pointer 1}  }
	{ local_bias_1_out int 8 regular {pointer 1}  }
	{ local_bias_out int 8 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "weight","offset": { "type": "dynamic","port_name": "weight","bundle": "control"},"direction": "READONLY"},{"cName": "bias","offset": { "type": "dynamic","port_name": "bias","bundle": "control"},"direction": "READONLY"},{"cName": "weight2","offset": { "type": "dynamic","port_name": "weight2","bundle": "control"},"direction": "READONLY"},{"cName": "bias2","offset": { "type": "dynamic","port_name": "bias2","bundle": "control"},"direction": "READONLY"},{"cName": "fcWeight","offset": { "type": "dynamic","port_name": "fcWeight","bundle": "control"},"direction": "READONLY"},{"cName": "fcBias","offset": { "type": "dynamic","port_name": "fcBias","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "fcBias", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "local_bias_9_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_bias_8_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_bias_7_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_bias_6_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_bias_5_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_bias_4_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_bias_3_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_bias_2_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_bias_1_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_bias_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ fcBias sc_in sc_lv 64 signal 1 } 
	{ local_bias_9_out sc_out sc_lv 8 signal 2 } 
	{ local_bias_9_out_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ local_bias_8_out sc_out sc_lv 8 signal 3 } 
	{ local_bias_8_out_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ local_bias_7_out sc_out sc_lv 8 signal 4 } 
	{ local_bias_7_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ local_bias_6_out sc_out sc_lv 8 signal 5 } 
	{ local_bias_6_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ local_bias_5_out sc_out sc_lv 8 signal 6 } 
	{ local_bias_5_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ local_bias_4_out sc_out sc_lv 8 signal 7 } 
	{ local_bias_4_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ local_bias_3_out sc_out sc_lv 8 signal 8 } 
	{ local_bias_3_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ local_bias_2_out sc_out sc_lv 8 signal 9 } 
	{ local_bias_2_out_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ local_bias_1_out sc_out sc_lv 8 signal 10 } 
	{ local_bias_1_out_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ local_bias_out sc_out sc_lv 8 signal 11 } 
	{ local_bias_out_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fcBias", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "fcBias", "role": "default" }} , 
 	{ "name": "local_bias_9_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_bias_9_out", "role": "default" }} , 
 	{ "name": "local_bias_9_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "local_bias_9_out", "role": "ap_vld" }} , 
 	{ "name": "local_bias_8_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_bias_8_out", "role": "default" }} , 
 	{ "name": "local_bias_8_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "local_bias_8_out", "role": "ap_vld" }} , 
 	{ "name": "local_bias_7_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_bias_7_out", "role": "default" }} , 
 	{ "name": "local_bias_7_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "local_bias_7_out", "role": "ap_vld" }} , 
 	{ "name": "local_bias_6_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_bias_6_out", "role": "default" }} , 
 	{ "name": "local_bias_6_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "local_bias_6_out", "role": "ap_vld" }} , 
 	{ "name": "local_bias_5_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_bias_5_out", "role": "default" }} , 
 	{ "name": "local_bias_5_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "local_bias_5_out", "role": "ap_vld" }} , 
 	{ "name": "local_bias_4_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_bias_4_out", "role": "default" }} , 
 	{ "name": "local_bias_4_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "local_bias_4_out", "role": "ap_vld" }} , 
 	{ "name": "local_bias_3_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_bias_3_out", "role": "default" }} , 
 	{ "name": "local_bias_3_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "local_bias_3_out", "role": "ap_vld" }} , 
 	{ "name": "local_bias_2_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_bias_2_out", "role": "default" }} , 
 	{ "name": "local_bias_2_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "local_bias_2_out", "role": "ap_vld" }} , 
 	{ "name": "local_bias_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_bias_1_out", "role": "default" }} , 
 	{ "name": "local_bias_1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "local_bias_1_out", "role": "ap_vld" }} , 
 	{ "name": "local_bias_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_bias_out", "role": "default" }} , 
 	{ "name": "local_bias_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "local_bias_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	fcBias { ap_none {  { fcBias in_data 0 64 } } }
	local_bias_9_out { ap_vld {  { local_bias_9_out out_data 1 8 }  { local_bias_9_out_ap_vld out_vld 1 1 } } }
	local_bias_8_out { ap_vld {  { local_bias_8_out out_data 1 8 }  { local_bias_8_out_ap_vld out_vld 1 1 } } }
	local_bias_7_out { ap_vld {  { local_bias_7_out out_data 1 8 }  { local_bias_7_out_ap_vld out_vld 1 1 } } }
	local_bias_6_out { ap_vld {  { local_bias_6_out out_data 1 8 }  { local_bias_6_out_ap_vld out_vld 1 1 } } }
	local_bias_5_out { ap_vld {  { local_bias_5_out out_data 1 8 }  { local_bias_5_out_ap_vld out_vld 1 1 } } }
	local_bias_4_out { ap_vld {  { local_bias_4_out out_data 1 8 }  { local_bias_4_out_ap_vld out_vld 1 1 } } }
	local_bias_3_out { ap_vld {  { local_bias_3_out out_data 1 8 }  { local_bias_3_out_ap_vld out_vld 1 1 } } }
	local_bias_2_out { ap_vld {  { local_bias_2_out out_data 1 8 }  { local_bias_2_out_ap_vld out_vld 1 1 } } }
	local_bias_1_out { ap_vld {  { local_bias_1_out out_data 1 8 }  { local_bias_1_out_ap_vld out_vld 1 1 } } }
	local_bias_out { ap_vld {  { local_bias_out out_data 1 8 }  { local_bias_out_ap_vld out_vld 1 1 } } }
}
