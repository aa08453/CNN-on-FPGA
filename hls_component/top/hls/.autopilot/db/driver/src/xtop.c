...
void XTop_Set_input_r(XTop *InstancePtr, u64 Data) {
    ...
    XTop_WriteReg(InstancePtr->Control_BaseAddress, XTOP_CONTROL_ADDR_INPUT_R_DATA, (u32)(Data));
    XTop_WriteReg(InstancePtr->Control_BaseAddress, XTOP_CONTROL_ADDR_INPUT_R_DATA + 4, (u32)(Data >> 32));
}
...
u64 XTop_Get_input_r(XTop *InstancePtr) {
    ...
    Data = XTop_ReadReg(InstancePtr->Control_BaseAddress, XTOP_CONTROL_ADDR_INPUT_R_DATA);
    Data += (u64)XTop_ReadReg(InstancePtr->Control_BaseAddress, XTOP_CONTROL_ADDR_INPUT_R_DATA + 4) << 32;
    return Data;
}
...
void XTop_Set_outputDense(XTop *InstancePtr, u64 Data) {
    ...
    XTop_WriteReg(InstancePtr->Control_BaseAddress, XTOP_CONTROL_ADDR_OUTPUTDENSE_DATA, (u32)(Data));
    XTop_WriteReg(InstancePtr->Control_BaseAddress, XTOP_CONTROL_ADDR_OUTPUTDENSE_DATA + 4, (u32)(Data >> 32));
}
...
u64 XTop_Get_outputDense(XTop *InstancePtr) {
    ...
    Data = XTop_ReadReg(InstancePtr->Control_BaseAddress, XTOP_CONTROL_ADDR_OUTPUTDENSE_DATA);
    Data += (u64)XTop_ReadReg(InstancePtr->Control_BaseAddress, XTOP_CONTROL_ADDR_OUTPUTDENSE_DATA + 4) << 32;
    return Data;
}
