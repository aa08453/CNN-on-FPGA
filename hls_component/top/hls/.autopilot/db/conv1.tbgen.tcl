...
dict set ap_memory_interface_dict outputConv_0 { MEM_WIDTH 7 MEM_SIZE 1255 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict outputConv_1 { MEM_WIDTH 7 MEM_SIZE 1255 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict outputConv_2 { MEM_WIDTH 7 MEM_SIZE 1255 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict outputConv_3 { MEM_WIDTH 7 MEM_SIZE 1255 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict outputConv_4 { MEM_WIDTH 7 MEM_SIZE 1255 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"},{"cName": "outputDense","offset": { "type": "dynamic","port_name": "outputDense","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
...
set portList { 
	...
	{ outputConv_0_address1 sc_out sc_lv 11 signal 2 } 
	{ outputConv_0_ce1 sc_out sc_logic 1 signal 2 } 
	{ outputConv_0_we1 sc_out sc_logic 1 signal 2 } 
	{ outputConv_0_d1 sc_out sc_lv 7 signal 2 } 
	...
	{ outputConv_2_address1 sc_out sc_lv 11 signal 4 } 
	{ outputConv_2_ce1 sc_out sc_logic 1 signal 4 } 
	{ outputConv_2_we1 sc_out sc_logic 1 signal 4 } 
	{ outputConv_2_d1 sc_out sc_lv 7 signal 4 } 
	{ outputConv_3_address1 sc_out sc_lv 11 signal 5 } 
	{ outputConv_3_ce1 sc_out sc_logic 1 signal 5 } 
	{ outputConv_3_we1 sc_out sc_logic 1 signal 5 } 
	{ outputConv_3_d1 sc_out sc_lv 7 signal 5 } 
	{ outputConv_4_address1 sc_out sc_lv 11 signal 6 } 
	{ outputConv_4_ce1 sc_out sc_logic 1 signal 6 } 
	{ outputConv_4_we1 sc_out sc_logic 1 signal 6 } 
	{ outputConv_4_d1 sc_out sc_lv 7 signal 6 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7085", "Max" : "7085"}
	, {"Name" : "Interval", "Min" : "7085", "Max" : "7085"}
]}
