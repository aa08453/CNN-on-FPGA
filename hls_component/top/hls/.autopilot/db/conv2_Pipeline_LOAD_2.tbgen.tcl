set moduleName conv2_Pipeline_LOAD_2
set isTopModule 0
...
set cdfgNum 22
set C_modelName {conv2_Pipeline_LOAD_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict temp_7 { MEM_WIDTH 8 MEM_SIZE 196 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict temp_6 { MEM_WIDTH 8 MEM_SIZE 196 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict temp_5 { MEM_WIDTH 8 MEM_SIZE 196 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict temp_4 { MEM_WIDTH 8 MEM_SIZE 196 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict temp_3 { MEM_WIDTH 8 MEM_SIZE 196 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict temp_2 { MEM_WIDTH 8 MEM_SIZE 196 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict temp_1 { MEM_WIDTH 8 MEM_SIZE 196 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict temp { MEM_WIDTH 8 MEM_SIZE 196 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem0 int 8 regular {axi_master 0}  }
	{ input_r int 64 regular  }
	{ temp_7 int 8 regular {array 196 { 3 0 } 0 1 }  }
	{ temp_6 int 8 regular {array 196 { 3 0 } 0 1 }  }
	{ temp_5 int 8 regular {array 196 { 3 0 } 0 1 }  }
	{ temp_4 int 8 regular {array 196 { 3 0 } 0 1 }  }
	{ temp_3 int 8 regular {array 196 { 3 0 } 0 1 }  }
	{ temp_2 int 8 regular {array 196 { 3 0 } 0 1 }  }
	{ temp_1 int 8 regular {array 196 { 3 0 } 0 1 }  }
	{ temp int 8 regular {array 196 { 3 0 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ temp_7_address1 sc_out sc_lv 8 signal 2 } 
	{ temp_7_ce1 sc_out sc_logic 1 signal 2 } 
	{ temp_7_we1 sc_out sc_logic 1 signal 2 } 
	{ temp_7_d1 sc_out sc_lv 8 signal 2 } 
	{ temp_6_address1 sc_out sc_lv 8 signal 3 } 
	{ temp_6_ce1 sc_out sc_logic 1 signal 3 } 
	{ temp_6_we1 sc_out sc_logic 1 signal 3 } 
	{ temp_6_d1 sc_out sc_lv 8 signal 3 } 
	{ temp_5_address1 sc_out sc_lv 8 signal 4 } 
	{ temp_5_ce1 sc_out sc_logic 1 signal 4 } 
	{ temp_5_we1 sc_out sc_logic 1 signal 4 } 
	{ temp_5_d1 sc_out sc_lv 8 signal 4 } 
	{ temp_4_address1 sc_out sc_lv 8 signal 5 } 
	{ temp_4_ce1 sc_out sc_logic 1 signal 5 } 
	{ temp_4_we1 sc_out sc_logic 1 signal 5 } 
	{ temp_4_d1 sc_out sc_lv 8 signal 5 } 
	{ temp_3_address1 sc_out sc_lv 8 signal 6 } 
	{ temp_3_ce1 sc_out sc_logic 1 signal 6 } 
	{ temp_3_we1 sc_out sc_logic 1 signal 6 } 
	{ temp_3_d1 sc_out sc_lv 8 signal 6 } 
	{ temp_2_address1 sc_out sc_lv 8 signal 7 } 
	{ temp_2_ce1 sc_out sc_logic 1 signal 7 } 
	{ temp_2_we1 sc_out sc_logic 1 signal 7 } 
	{ temp_2_d1 sc_out sc_lv 8 signal 7 } 
	{ temp_1_address1 sc_out sc_lv 8 signal 8 } 
	{ temp_1_ce1 sc_out sc_logic 1 signal 8 } 
	{ temp_1_we1 sc_out sc_logic 1 signal 8 } 
	{ temp_1_d1 sc_out sc_lv 8 signal 8 } 
	{ temp_address1 sc_out sc_lv 8 signal 9 } 
	{ temp_ce1 sc_out sc_logic 1 signal 9 } 
	{ temp_we1 sc_out sc_logic 1 signal 9 } 
	{ temp_d1 sc_out sc_lv 8 signal 9 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	temp_7 { ap_memory {  { temp_7_address1 MemPortADDR2 1 8 }  { temp_7_ce1 MemPortCE2 1 1 }  { temp_7_we1 MemPortWE2 1 1 }  { temp_7_d1 MemPortDIN2 1 8 } } }
	temp_6 { ap_memory {  { temp_6_address1 MemPortADDR2 1 8 }  { temp_6_ce1 MemPortCE2 1 1 }  { temp_6_we1 MemPortWE2 1 1 }  { temp_6_d1 MemPortDIN2 1 8 } } }
	temp_5 { ap_memory {  { temp_5_address1 MemPortADDR2 1 8 }  { temp_5_ce1 MemPortCE2 1 1 }  { temp_5_we1 MemPortWE2 1 1 }  { temp_5_d1 MemPortDIN2 1 8 } } }
	temp_4 { ap_memory {  { temp_4_address1 MemPortADDR2 1 8 }  { temp_4_ce1 MemPortCE2 1 1 }  { temp_4_we1 MemPortWE2 1 1 }  { temp_4_d1 MemPortDIN2 1 8 } } }
	temp_3 { ap_memory {  { temp_3_address1 MemPortADDR2 1 8 }  { temp_3_ce1 MemPortCE2 1 1 }  { temp_3_we1 MemPortWE2 1 1 }  { temp_3_d1 MemPortDIN2 1 8 } } }
	temp_2 { ap_memory {  { temp_2_address1 MemPortADDR2 1 8 }  { temp_2_ce1 MemPortCE2 1 1 }  { temp_2_we1 MemPortWE2 1 1 }  { temp_2_d1 MemPortDIN2 1 8 } } }
	temp_1 { ap_memory {  { temp_1_address1 MemPortADDR2 1 8 }  { temp_1_ce1 MemPortCE2 1 1 }  { temp_1_we1 MemPortWE2 1 1 }  { temp_1_d1 MemPortDIN2 1 8 } } }
	temp { ap_memory {  { temp_address1 MemPortADDR2 1 8 }  { temp_ce1 MemPortCE2 1 1 }  { temp_we1 MemPortWE2 1 1 }  { temp_d1 MemPortDIN2 1 8 } } }
}
